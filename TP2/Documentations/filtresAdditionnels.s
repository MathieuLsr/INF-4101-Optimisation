...
passeHaut :	.word 0, -1, 0, -1, 5, -1, 0, -1, 0
laPlace :	.word 0, 1, 0, 1, -4, 1, 0, 1, 0 

choixFiltre :	.asciiz "Entrez 1 pour le filtre passe-haut, ou 2 pour le filtre de laPlace"
...
########## Allocation et lecture de l'image
	...
	subu $sp $sp 8			#réservation de 2 adresses dans la pile
...
########## Opérations (produit de convolution)
	...
	beq $v0 1 choixPasseHaut
	beq $v0 2 choixLaPlace
	j mauvaisChoix
...
choixOk :
	lw $a0 4($sp) 			#produit de convolution avec laPlace ou passeHaut
	jal storeConv
...
finloop0:
	bgez $s0 finconvolution		#seuil 0
	li $s0 0
